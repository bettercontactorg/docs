...
| `404` | Unknown Lead Finder `request_id`, or no company matched on [Enrich a company profile](/api-reference/enrich_profile/company). | Check the input, do not retry. |
